...
contains
  ...
  subroutine lnd_export( bounds, lnd2atm_inst, lnd2glc_inst, l2x)
    ...
    !      end do
    !      write(iulog,*) 'gridcell index = ', g
    !      write(iulog,*) l2x(index_l2x_Sl_t,i)       , ' lnd2atm_inst%t_rad_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Sl_snowh,i)   , ' lnd2atm_inst%h2osno_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Sl_avsdr,i)   , ' lnd2atm_inst%albd_grc(g,1)'
    !      write(iulog,*) l2x(index_l2x_Sl_anidr,i)   , ' lnd2atm_inst%albd_grc(g,2)'
    !      write(iulog,*) l2x(index_l2x_Sl_avsdf,i)   , ' lnd2atm_inst%albi_grc(g,1)'
    !      write(iulog,*) l2x(index_l2x_Sl_anidf,i)   , ' lnd2atm_inst%albi_grc(g,2)'
    !      write(iulog,*) l2x(index_l2x_Sl_tref,i)    , ' lnd2atm_inst%t_ref2m_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Sl_qref,i)    , ' lnd2atm_inst%q_ref2m_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Sl_u10,i)     , ' lnd2atm_inst%u_ref10m_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_taux,i)  , '-lnd2atm_inst%taux_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_tauy,i)  , '-lnd2atm_inst%tauy_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_lat,i)   , '-lnd2atm_inst%eflx_lh_tot_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_sen,i)   , '-lnd2atm_inst%eflx_sh_tot_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_lwup,i)  , '-lnd2atm_inst%eflx_lwrad_out_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_evap,i)  , '-lnd2atm_inst%qflx_evap_tot_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Fall_swnet,i) , ' lnd2atm_inst%fsa_grc(g)'
    !      write(iulog,*) l2x(index_l2x_Flrl_rofsur,i), ' sum of qflx_over, qflx_h2osfc_surf'
    !      write(iulog,*) l2x(index_l2x_Flrl_rofsub,i), ' sum of qflx_drain and qflx_perched_drain'
    !      write(iulog,*) l2x(index_l2x_Flrl_rofgwl,i), ' qflx_rofliq_qgwl_grc'
    !      write(iulog,*) l2x(index_l2x_Flrl_rofi,i)  , ' qflx_rofice_grc'
    !      write(iulog,*) l2x(index_l2x_Flrl_irrig,i) , ' qirrig_grc'
    !
    !   if (index_l2x_Fall_fco2_lnd /= 0) then
    !      l2x(index_l2x_Fall_fco2_lnd,i) = -lnd2atm_inst%net_carbon_exchange_grc(g)
    !   end if
