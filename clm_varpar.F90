module clm_varpar
  ...
  ! jsong
  ! CanopyTurbulence
  integer, parameter :: isun=1
  integer, parameter :: isha=2
  integer, parameter :: nleaf=2
  ...
  integer, parameter :: nlevcanml     =   30     ! number of leaf layers in canopy layer
  integer, parameter :: nlevcanmll     =   nlevcanml+1     ! number of leaf layers in canopy layer
