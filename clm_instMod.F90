module clm_instMod
  ...
  use CanopyFluxesMultilayerType , only : mlcanopy_type !jsong
  !-----------------------------------------
  ! Constants
  !-----------------------------------------
  ...
  type(mlcanopy_type)                  :: mlcanopy_inst !jsong
...
contains
  ...
  subroutine clm_instInit(bounds)
	...
	call mlcanopy_inst%Init(bounds)
  ...
  subroutine clm_instRest(bounds, ncid, flag)
	...
	call mlcanopy_inst%restart (bounds, ncid, flag=flag) !jsong
